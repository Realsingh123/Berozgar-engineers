...
const Footer = () => {
  return (
    <footer className="bg-white text-gray-800">
      ...
      {/* Bottom Bar */}
      <div className="bg-black text-white text-xs mt-0">
        <div className="max-w-7xl mx-auto px-10 py-6 flex flex-col md:flex-row justify-center items-center gap-3">
          <p className="text-center md:text-left">
            © 2025 Logo Inc. - All Rights Reserved
          </p>
          <div className="flex ml-50 space-x-6">
