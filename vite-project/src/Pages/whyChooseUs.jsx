      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
        ...
        <div className="flex flex-col justify-between h-full">
          ...
          <img
            src={whyusImg}
            alt="Why Choose Us"
            className="rounded-3xl shadow-lg w-[100px] md:w-[260px] lg:w-[280px] h-auto object-cover mx-auto lg:mx-0"
          />
        </div>
        ...
        <div className="flex flex-col gap-10">
          {features.map((feature, index) => (
            <div key={index} className="flex items-start gap-5">
              <div className="bg-indigo-600 p-4 rounded-xl shadow-md flex items-center justify-center flex-shrink-0">
                {feature.icon}
              </div>
              <div>
